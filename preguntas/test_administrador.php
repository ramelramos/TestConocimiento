...
if(mysql_num_rows($resultado) == 0) {
	...
	echo "<a href='resultado_administrador.php' class='btn btn-success'>Resultados</a>";
...
<form action="test-action-administrador.php" method="post" name="formulario_preguntas">
<br>
...
if ($busca = mysql_fetch_row($rs)){
 ...
 ?>
<h1><?php echo "$id_pregunta / $id";} ?><a href="../menu-administrador.php" style="margin-left:10px;" class="btn btn-danger btn-xs">Volver Al Menu</a></h1><br>
