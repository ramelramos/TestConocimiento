                                            ...
                                            echo "<h1 align='center'>SIN REGISTROS</h1>";
                                                ...
                                                ?>
                                                    <form action="" method="post" id="formulario" style="color:black"><br>    
                                                        ...
                                                        <button name="buscar" value="submit" class="btn btn-default btn-xs">buscar</button><a href="historial_administrador.php"  style="margin-left:4px;" class="btn btn-info btn-xs">Lista General</a><a href="menu-administrador.php" style="margin-left:4px;" class="btn btn-danger btn-xs">Volver</a>
                                                    </form><br>
